...
import 'package:ar_cli/src/command_runner.dart';
...
void main() {
  group('ArCliCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late ArCliCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = ArCliCommandRunner(
        logger: logger,
    ...
    test('can be instantiated without an explicit analytics/logger instance',
        () {
      final commandRunner = ArCliCommandRunner();
